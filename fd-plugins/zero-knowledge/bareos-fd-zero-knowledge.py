...
# BareosFdPluginBareosFdPluginZeroKnowledge. The plugin argument 'filename' is used to read
...
import BareosFdPluginZeroKnowledge
...
def load_bareos_plugin(context, plugindef):
    ...
    BareosFdWrapper.bareos_fd_plugin_object = BareosFdPluginZeroKnowledge.BareosFdPluginZeroKnowledge(
        context, plugindef
    )
